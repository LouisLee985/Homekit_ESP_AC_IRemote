...
* 需有电工基础和空调维修经验。 
* SDA,SCL,3V3,GND红色标记处，用于外接[温湿度传感器模块](https://github.com/LouisLee985/Homekit-Air-Conditioner-Remote/tree/main/hardware/AC_IR_Homekit_Inside_3.0_0402)。避免因PCB过于紧凑，导致PCB上SHTC3受ESP-01F散热干扰而测温始终高的问题。
